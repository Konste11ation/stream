...
#Reg Notation
#reg_SIZE_1r1w/2r2w/_BW
#reg_64B_1r1w_8b:
# a 64B register with 1 read port 1 write port and
# we can read 8B per CC

#SRAM Notation
#sram_SIZE_BANK_BANKSIZE_rw_BANKBW
#sram_32KB_2_16KB_1r1w_64b
# a 32KB SRAM with 2 16KB bank
# we can fetch 64b*2 data per CC
