...
accelerator = "stream-dvfs/inputs/multicore_system/4core.yaml"
mapping_path = "stream-dvfs/inputs/multicore_mapping/4core_llama_hand_mapping.yaml"

mode = "lbl"
# layer_stacks = [tuple(range(0, 23)), tuple(range(23, 41)), tuple(range(41, 66))]
